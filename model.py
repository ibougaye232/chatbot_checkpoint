...
def main():
    st.title("Chatbot")
    st.write("Salut, je suis le chatbot de Ibrahima, spécialiste en Steve Jobs je répondrais à toutes tes questions. Et parle français en, pas anglais")
    ...
    if st.button("Submit"):
        ...
        st.write("Voici la réponse: " + response)
